...
var SelectWrapper = _styledComponents["default"].span(_templateObject12(), Arrow, _styles.color.mediumdark, Selector, _styles.color.primary, function (props) {
...
function Select(_ref2) {
  ...
  return _react["default"].createElement("div", {
    ...
    htmlFor: id
  }, label)), _react["default"].createElement(SelectWrapper, {
    appearance: appearance,
    icon: icon,
    error: error,
    "data-error": error,
    disabled: disabled
  }, !inProgress && _react["default"].createElement(Arrow, null), _react["default"].createElement(Selector, (0, _extends2["default"])({
    id: id,
    value: value
  }, other, {
    ...
    return _react["default"].createElement(Option, (0, _extends2["default"])({}, option, {
      key: option.value
    }));
  })), icon && _react["default"].createElement(SelectIcon, {
    icon: icon,
    "aria-hidden": true
  }), error && _react["default"].createElement(SelectError, {
    id: errorId
  }, error), inProgress && _react["default"].createElement(SelectSpinner, {
    id: spinnerId,
    "aria-label": "Loading",
    inForm: true
  })));
