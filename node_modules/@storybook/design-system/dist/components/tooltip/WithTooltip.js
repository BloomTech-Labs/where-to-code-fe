...
var AsComponent = _react["default"].forwardRef(function (_ref, ref) {
  ...
  var asProps = (0, _objectSpread2["default"])({
    ref: ref,
    onClick: onClick,
  ...
  var onKeyDown = (0, _react.useMemo)(function () {
    return function (event) {
      ...
      if (event.keyCode === (0, _keycode["default"])('enter') || event.keyCode === (0, _keycode["default"])('space')) {
  ...
  return _react["default"].createElement(Component, asProps);
});
...
function WithTooltip(_ref2) {
  ...
  return _react["default"].createElement(_reactPopperTooltip["default"], {
    ...
    return _react["default"].createElement(AsComponent, (0, _extends2["default"])({
      tagName: tagName,
      ref: triggerRef
