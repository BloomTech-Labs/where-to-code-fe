...
var InputWrapper = _styledComponents["default"].div(_templateObject6(), InputText, _styles.color.lightest, _styles.color.darkest, function (props) {
  ...
  return props.appearance === 'code' && (0, _styledComponents.css)(_templateObject12());
}, function (props) {
...
function Input(_ref) {
  ...
  return _react["default"].createElement(InputContainer, {
    ...
    icon: icon,
    "aria-hidden": true
  }), _react["default"].createElement(InputText, (0, _extends2["default"])({
    id: id,
    value: value,
    "aria-describedby": errorId,
    "aria-invalid": !!error
  }, props)), _react["default"].createElement(Error, {
    id: errorId
  }, error)));
}
